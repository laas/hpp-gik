...
ChppGikRelativeComConstraint::computeValue()
{
  ...
  ChppGikTools::HtoRT(joint->currentTransformation(),jointRot_,jointTr_);
...
ChppGikRelativeComConstraint::computeJacobian()
{
  ...
  robot().getPositionJacobian(*robot().rootJoint(),*rootJoint_,localTarget_,posJacobian_,0,false);
